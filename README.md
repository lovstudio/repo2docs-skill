...
```bash
git clone https://example.com/skills/repo2docs-skill "${SKILL_SKILLS_INSTALL_DIR:?Set SKILL_SKILLS_INSTALL_DIR}/sgc-repo2docs"
```
...
- The [`sgc-deploy-to-vercel`](https://example.com/skills/deploy-to-vercel-skill)
...
```bash
SKILL_DIR="${SKILL_SKILLS_INSTALL_DIR:?}/sgc-repo2docs"
